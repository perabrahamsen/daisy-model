...
\item Measurements at both sites show
  ...
  remobilizable glyphosate within the preferential transport system, a
...
happens in the plow layer, see e.g.\ the first year horizontal bromide
flux (figure~\ref{fig:Estrup-Bromide-2000-horizontal}).
