...
$\mathbf{v}_{\text{m}}$. The last would could result in infinitely
...
solute can be absorbed, moved to the immobile water or the
macropore domain or be subject to chemical or biological reduction.
...
that the Peclet number raises over 2?. For simulations where the
water not is divided into a mobile and a immobile region, i.e
$\theta_{\text{im}}$ and $\theta_{\text{m}}=\theta$ the
...
\frac{\partial C_{\text{m}}}{\partial t}=D\frac{\partial^2C_{\text{m}}}{\partial
  x^2}-v\frac{\partial C\text{m}}{\partial x}
\end{equation}
%
...
%
\begin{equation}
\left(-D\frac{\partial C\text{m}}{\partial x}+vC\text{m} \right)\bigg\vert_{x=0}=vC_{\text{m,0}}
\end{equation}
