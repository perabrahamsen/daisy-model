...
%     \fig{piezo-sim-0001}
%   \end{center}
%   \caption{Simulated pressure at 230 cm below surface, first, second and third drain season.}
%   \label{fig:piezo-sim}
%\end{figure}
...
% \begin{figure}[htbp]
%   \begin{center}
%     \figtop{piezo-70-0001}
%     \fig{piezo-400-0001}
%     \fig{piezo-800-0001}
%   \end{center}
%   \caption{Pressure at 230 cm below surface, 70 cm (top), 4 m (middle) and 8 m (bottom) from drain.  Third drain season.}
%   \label{fig:piezo-0001}
%\end{figure}
