...
documented
in~\citet{Petersen200181,petersen2002movement,petersen2004movement,petersen2008spatio}.
...
present project~\citep{habekost1}.
...
\item A setup for water using the new 2D model and new biopore model
  for water only by Nanna Gudmand-Høyer, as part of her Master
  Thesis~\citep{nanna-agrovand}.
...
Used for development.  Redo from scrath.
