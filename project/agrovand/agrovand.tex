...
in~\citet{mmax} (method 1).  From calibration, we would that the
detachment rate coefficient ($k_d$) should be decreased to 7.5 g/J,
the replenishment rate ($k_r$) to 0.1 g/m$^2$/h, and the depth of the
soil affected by detachment and dispersion ($z_i$) to 0.5 mm.
