...
documented in \citet{Petersen200181}.   
...
data from plot 4, representing conventional tillage.  Apart from
...
simulate.  Apart from drain water, soil water have been followied with
piezometers, tensiometers, and TDR probes.  The most stable results
are from the TDR probes, and the only one we have used for our
calibration.  
