...
\begin{tabular}{lllllll}
  ...
  & cm & cm & cm & h$^-1$ & h$^-1$ \\
  0.998547 & -5.26238e+09 & -853.566 & -997.502 & 8.39902e-05 & 0.000100855
\end{tabular}
...
\begin{tabular}{llll}
  R$^2$ & K$_{clay}$ & pore$_{min}$ & Applied\\
  & cm$^3$/g & $\mu$m & g/ha\\
  0.898343 & 2.55078 & 0.599901 & 3.10622e+06
\end{tabular}

%% \section*{u13 Bromide in soil samples}
%% 
%% \noindent\fig{u13-Bromide}
%% 
%% \section*{u13 Brilliant Blue in soil samples}
%% 
%% \noindent\fig{u13-BB-base}
%% 
...
\begin{tabular}{lllllll}
  R$^2$ & S$_{lim}$ & A$_{lim}$ & B$_{lim}$ & S$_\alpha$ & X$_\alpha$ \\
  & cm & cm & cm & h$^-1$ & h$^-1$ \\
  0.999935 & -16019.5 & -318.314 & -160.896 & 4.61272e-13 & 1.7699e-05
...
%%    R$^2$ & K$_{clay}$ & pore$_{min}$ & Applied\\
%%    & cm$^3$/g & $\mu$m & g/ha\\
%%    0.92877 & 1.47412 & 1 & 2.47412e+06 (14.0\%)
%%  \end{tabular}
%% 
R$^2$ = 0.609226
...
\begin{tabular}{lllllll}
  R$^2$ & S$_{lim}$ & A$_{lim}$ & B$_{lim}$ & S$_\alpha$ & X$_\alpha$ \\
  & cm & cm & cm & h$^-1$ & h$^-1$ \\
  0.996858 & -14990.2 & -371.453 & -268.55 & 2.49667e-15 & 4.07494e-05
\end{tabular}
...
%%   R$^2$ & K$_{clay}$ & pore$_{min}$ & Applied\\
%%   & cm$^3$/g & $\mu$m & g/ha\\
%%   -1.04494 & 0.285611 & 0.1 & 285611 (1.6\%)
%% \end{tabular}

R$^2$ = -3.73232


%% \section*{d4 Bromide in soil samples}
%% 
%% \noindent\fig{d4-Bromide}
%% 
%% \section*{d4 Brilliant Blue in soil samples}
%% 
%% \noindent\fig{d4-BB-base}

\section*{ucd Bromide in soil samples}

\noindent\fig{ucd-Bromide}

\section*{ucd Brilliant Blue in soil samples}

\noindent\fig{ucd-BB-base}

\section*{u4 Initial soil water}

\noindent\fig{u4-Pres}

\section*{m19 Initial soil water}

\noindent\fig{m19-Pres}

\section*{d1 Initial soil water}
