                                       ...
                                       const double dt, Treelog& msg)
{
  ...
  daisy_assert (snow_ea_ <= total_ep);
  canopy_ep = (total_ep - snow_ea_) * vegetation.cover ();
  ...
  litter_ep = (total_ep - snow_ea_) * (1.0 - vegetation.cover ());
  daisy_assert (snow_ea_ <= total_ep);
  if (litter_ep < 0.0)
    {
