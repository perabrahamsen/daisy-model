// ABAprod_soil.C  -- ABA production based on soil length.
// 
...
ABA production based on concentration in soil.\n\
\n\
...
Expression to evaluate to ABA concentration in soil [g/cm^3].\n\
