...
\begin{itemize}
\item Shortening the article.  Should I
  \begin{itemize}
  \item Remove first paragraph and start of second paragraph from
    Introduction?
  \item Remove the solutions to W and Q.  ``They can be found using
    Newton's method''?
  \item Remove first paragraph of Results, plus the yield and
    phenology tables?
  \end{itemize}
