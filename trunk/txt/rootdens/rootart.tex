...
distribution of the roots, due to the reliance of root signals.
Several models incorporating this exists,
...
\begin{equation}
  ...
  \label{eq:Lambert}
\end{equation}
If the root length is TODO The equation may have multiple solutions, but only the solution for
$W\leq-1$ is physically meaningful.  It can be found using Newton's
method and an initial quess of $-2$.  After finding a value for $W$,
we can find the desired density parameters $L_0$ and $a$ by
substituting back
\begin{eqnarray}
