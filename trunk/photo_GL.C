...
private:
  ...
  // Simulation.
public:
  double assimilate (const Units&, const double, const double, const double, const double,
...
double
PhotoGL::assimilate (const Units&, const double, const double, const double, const double,
