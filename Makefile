...
SHELL = /bin/sh
CC = /pack/gcc-2.7.1/bin/c++ -Wall -g -frepo # -fhandle-exceptions -pipe -fno-implicit-templates
...
test:	daisy
	daisy test.dai
	diff old.chp test.chp
	diff old.log test.log
...
input.o: input.C input.h daisy.h time.h manager.h weather.h \
 groundwater.h log.h uzmodel.h horizon.h column_std.h column.h \
...
soil_water.o: soil_water.C soil_water.h
...
soil_heat.o: soil_heat.C soil_heat.h daisy.h time.h alist.h \
 bioclimate.h
groundwater.o: groundwater.C groundwater.h syntax.h
