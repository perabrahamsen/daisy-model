...
Slow SMB pool parameterization.")
  ...
  void load_frame (Frame& frame) const
  {
    ...
    frame.add ("C_per_N", SMB1_C_per_N);
    frame.add ("turnover_rate", 7.708e-6);
    std::vector<double> SMB1_efficiency;
    SMB1_efficiency.push_back (0.60);
    SMB1_efficiency.push_back (0.60);
    frame.add ("efficiency", SMB1_efficiency);
    frame.add ("maintenance", 7.500e-5);
    ...
    SMB1_fractions.push_back (0.0);
    frame.add ("fractions", SMB1_fractions);
  }
} SMBSlow_syntax;
...
Fast SMB pool parameterization.")
  ...
  void load_frame (Frame& frame) const
  {
    ...
    frame.add ("C_per_N", SMB2_C_per_N);
    frame.add ("turnover_rate", 4.16666666667e-4);
    std::vector<double> SMB2_efficiency;
    SMB2_efficiency.push_back (0.60);
    SMB2_efficiency.push_back (0.60);
    frame.add ("efficiency", SMB2_efficiency);
    frame.add ("maintenance", 4.16666666667e-4);
    ...
    SMB2_fractions.push_back (0.0);
    frame.add ("fractions", SMB2_fractions);
  }
} SMBFast_syntax;
