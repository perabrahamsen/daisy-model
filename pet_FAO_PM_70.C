// pet_FAO_PM_70.C -- FAO ETc using Penman-Monteith with hourly data
// 
...
public:
  ...
  PetFAO_PM_70 (const BlockModel& al)
    : Pet (al),
...
void
PetFAO_PM_70::tick (const Time&, const Weather& weather, const double /* Rn */,
                        const Vegetation& crops,
...
static struct PetFAO_PM_70Syntax : public DeclareModel
{
  Model* make (const BlockModel& al) const
  { return new PetFAO_PM_70 (al); }
  PetFAO_PM_70Syntax ()
    : DeclareModel (Pet::component, "FAO_PM_70",
