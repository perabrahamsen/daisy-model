...
bool 
AM::is_mineral (const Metalib&, const AttributeList& am)
{ return am.name ("syntax") == "mineral"; }

bool 
AM::is_organic (const Metalib&, const AttributeList& am)
{ return am.name ("syntax") == "organic"; }
