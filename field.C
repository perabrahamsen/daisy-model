...
struct Field::Implementation
{
  ...
  // Actions.
  void sow (Metalib&, const AttributeList& crop, const double row_width,
  ...
  if (selected)
    {
      ...
      selected->sow (metalib, crop, row_width, time, dt, msg);
    }
  else 
    {
	   ...
	   i++)
	{
	  ...
	  (*i)->sow (metalib, crop, row_width, time, dt, msg);
	}
    }
}
