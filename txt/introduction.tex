...
The type of the `time' attribute is a `time value', as described in
...
Time values, PLF's, submodels, and fixed components are different
...
like the one below.
\begin{verbatim}
  You have 20 intervals but 26 T values
  in column `JB1_Richards'
  Malformed column(s)
\end{verbatim}
