...
\item TODO: Two sites CAAS. Location. Potato.  CAU.  Near Beijing.
  ...
  may nonetheless have an effect.  Three replications.  Root density
...
\item TODO: Find solution for both 1D and 2D model.  The 2D model is a
  proper superset of the 1D model (\ref{sec:mapping}) with one more
...
\begin{table}[htbp]
  \caption{Final yield.  All numbers are wt weight.  The ``China''
    number is the average Chinese yield that year, as reported to FAO 
