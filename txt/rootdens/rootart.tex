...
\item TODO: Modellering af PRD kræver jordfysisk beskrivelse af vand
  bevægelse i 2 dimensioner, samt en 2D model for rodtæthed.
\item TODO: 
\end{itemize}
...
\cite{nelder1965simplex}

\section{Results}

\begin{itemize}
\item TODO: 5 tabeller med resultater
\item TODO: Evt. 3 tabeller med oplysninger om mark.
\item TODO: Evt. FAO Kina gennemsnitsudbytte.
\end{itemize}
...
sampling.  This pattern is partly supported by the 2006 CAU data.
...
= 0.30$.  For the aggregated datesets, $R^2$ range from 0.56 to 0.92.  

Based on this we believe the model is useful for the intended purpose
of modelling water dynamics in row crops with PRD irrigation.
...
optionally, root zone width.  The software is written in \cplusplus{}
and covered by on open source license (\textsc{gnu lgpl}), so it can
be freely incorporated in other models.

The root density data from the two field sites will be made available
at\linebreak[4] \url{http://www.safir4eu.org/} from TODO-XXXX-DATE
