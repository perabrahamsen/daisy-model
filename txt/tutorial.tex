...
or by most spreadsheets.

\subsection{Excel}

Change to American numbers.

\subsection{ShowDaisyOutput}

Can be fetched from the \daisy{} homepage.

Good for overview.  Can plot a soil profile, and animate it.
Allows zooming.  No printing.

\subsection{gnuplot}
\label{sec:gnuplot}

There is a link to the binary on the \daisy{} homepage.

\subsection{Using gnuplot manually}
\label{gnuplot-man}
