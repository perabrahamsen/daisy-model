...
\linebreak{}\texttt{canopy\_washoff\_coefficient} can (roughly) be
thought of as the amount of water that must fall off the canopy, in
order to wash half the pesticide off.
