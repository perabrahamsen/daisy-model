...
\begin{abstract}
  ...
  \href{mailto:daisy-model-devel@googlegroups.com}{\texttt{$<$daisy-model-devel@googlegroups.com$>$}}.
\end{abstract}
...
address~\url{https://daisy.ku.dk/}, the home page of the Daisy
project.  Follow the download instructions for your system, and find
the \texttt{test.dai} under \texttt{sample}, in the directory (folder)
where Daisy was installed.

You must copy the \texttt{test.dai} to a different directory where you
have write permission. Never make any changes in the install
directory, and never run Daisy on files located there.
