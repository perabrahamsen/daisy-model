...
By default, Daisy will choose the best model calculaing the reference
...
evaporation when when found in the weather file.
...
of a specific pesticide, such as `Atrazine', specify the
\emph{\texttt{chemical}} parameter, as in:
\begin{verbatim}
