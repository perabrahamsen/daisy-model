...
and robustly to the simulation state is an endless source of fun.
However, specifying each and every little management operation for a
30 year run can get both tedious and error prone.
...
available pesticide parameterizations are \texttt{Atrazine},
