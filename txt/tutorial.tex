...
Store all the files in the same directory, unzip the parameter library
and the sample files, open a shell or command prompt, change directory
to the where the parameter library files were stored, and run the
command \texttt{daisy ../sample/test.dai} to check that everything works.  It
should start printing dates to show the progress of the simulation.
After simulation has finished, you can browse the `\texttt{daisy.log}'
file to see the output again.
...
but that will soon change.  The string \texttt{"Andeby top soil."} is
a description of the horizon, and is a good place to put information
