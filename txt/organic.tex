...
Danish conditions high clay content (10\%).  Figure~\ref{fig:clayom}
shows the \textsc{som1}/\textsc{som2} ratio, which can be used for
initializing \daisy{}.  Finally, figure~\ref{fig:sandom} shows the a
simulation on a coarse sandy soil going from a low to high input
equilibrium.
...
for $T < 0^\circ$C, so for a cold climate like the Danish the
