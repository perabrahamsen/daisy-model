...
organic matter), or \textsc(aom).  Then we have the soil microbial
biomass, or \textsc(smb), the living part of the organic matter, excluding
roots.  Finally we have the humus, the soil organic matter (\textsc{som}),
...
models that are concern with nitrogen.  Having two \textsc{som} and two
\textsc{smb} pools allows a well calibrated model to capture both the
...
may be needed.  The number \textsc{aom} pools needed also depends on what
...
Figure~\ref{fig:clayration} shows the \textsc{som1}/\textsc{som2} ratio, which
