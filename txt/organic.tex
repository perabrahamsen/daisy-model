...
of the \textsc{som2} pool, we see that only 90\% of the carbon not
lost as CO$_2$ become biomass, the remaining 10\% end up in
...
made by Torsten Müller \citep{mueller-smb}, who adjusted the turnover
...
was made by Sander Bruun \citep{daisy-somnew}.  This was a complete
...
observed empirically \citep{dk-humus-change}.
...
focus on the effect of clay \citep{biomod,biomod2}, and some wishlist
items include phosphor dynamics \citep{bgj-ptr} and a calibration for
