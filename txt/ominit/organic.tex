...
\begin{equation}
  ...
  \begin{array}{lcll}
    ...
    \sum_{j=1}^{N_\mbox{\textsc{smb}}} a_{i,j}\,\mbox{\textsc{smb}}j +
    \sum_{j=1}^{N_\mbox{\textsc{som}}} b_{i,j}\,&\mbox{\textsc{som}}j\\
    & & + \sum_{j=1}^{N_\mbox{\textsc{aom}}} c_{i,j}\,\mbox{\textsc{aom}}j
    &;i = 1\ldotsN_\mbox{\textsc{smb}}\\
    \Delta\mbox{\textsc{som}}i &=& \displaystyle
    \sum_{j=1}^{N_\mbox{\textsc{smb}}} d_{i,j}\,\mbox{\textsc{smb}}j +
    \sum_{j=1}^{N_\mbox{\textsc{som}}} e_{i,j}\,&\mbox{\textsc{som}}j\\
    & & + \sum_{j=1}^{N_\mbox{\textsc{aom}}} f_{i,j}\,\mbox{\textsc{aom}}j
    &;i = 1\ldotsN_\mbox{\textsc{som}}\\
    \Delta\mbox{\textsc{aom}}i &=& \displaystyle g_i\,\mbox{\textsc{aom}}i
    &;i = 1\ldotsN_\mbox{\textsc{aom}}\\
  \end{array}
\end{equation}
...
the change of each pool (mass per time).  $N_\mbox{\textsc{aom}}$,
$N_\mbox{\textsc{smb}}$, and $N_\mbox{\textsc{som}}$ denote the number of
...
\begin{equation}
  \label{eq:smb-eq}
  \Delta\mbox{\textsc{smb}}i = 0 \hspace{1cm};i = 1\ldotsN_\mbox{\textsc{smb}}
\end{equation}
...
\begin{equation}
  \label{eq:total}
  total = \sum_{i=1}^{N_\mbox{\textsc{smb}}} \mbox{\textsc{smb}}i
    + \sum_{i=1}^{N_\mbox{\textsc{som}}} \mbox{\textsc{som}}i
    + \sum_{i=1}^{N_\mbox{\textsc{aom}}} \mbox{\textsc{aom}}i
\end{equation}
The final common assumption is that the carbon input is known, as in
Equation~\ref{eq:input}.
\begin{equation}
  \label{eq:input}
  \Delta\mbox{\textsc{aom}}i = k_i \hspace{1cm};i = 1\ldotsN_\mbox{\textsc{aom}}
\end{equation}
...
$N_\mbox{\textsc{som}}-1$ equations before we can solve the system.
...
\begin{equation}
  ...
  \mbox{som}i = f_{\mbox{\scriptsize\textsc{som}}i} 
    \sum_{j=1}^{N_\mbox{\textsc{som}}} \mbox{\textsc{som}}
    \hspace{1cm};i = 1\ldotsN_\mbox{\textsc{som}}
\end{equation}
where $f_{\mbox{\scriptsize\textsc{som}}i}$ are user supplied
constants.  This gives us N_\mbox{\textsc{som}} additional equations,
however since $\sum_{i=1}^{N_\mbox{\textsc{som}}}
...
\begin{equation}
  \label{eq:cn}
  background = \sum_{i=1}^{N_\mbox{\textsc{som}}}
...
\begin{equation}
  \label{eq:som-eq}
  \Delta\mbox{\textsc{som}}i = 0 \hspace{1cm};i = 1\ldotsN_\mbox{\textsc{som}}
\end{equation}
...
will be less relevant.  However, the \textsc{som} pools can take
centuries to reach equilibrium with new input levels.
...
\begin{figure}[htbp]
  ...
  \label{fig:orgJB1}
\end{figure}
As can be seen, equilibrium is reached after 200 (sandy loam,
increasing input) to 600 (sand, decreasing output).  When 
