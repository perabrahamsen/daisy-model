...
\subsection{Evolution of the organic matter model}

The original organic matter model in \daisy{} \citep{daisy-def} is
depicted in Figure~\ref{fig:om1} which define a system with two pools
of \textsc{som} and \textsc{smb}, and two pools of \textsc{aom} for
each type of fertilizer applied and crop residues left on the field.
