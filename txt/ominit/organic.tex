...
the dynamic model is shown in Eq.~\ref{eq:generic}.
\begin{equation}
  \label{eq:generic}
  \begin{array}{lcll}
...
the equations added by Eq.~\ref{eq:som-eq}, and keep all of
...
Fig.~(\ref{fig:long})), the organic matter content of the soil will
