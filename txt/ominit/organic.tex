...
Eqs.~\ref{eq:som-fractions}, \ref{eq:smb-eq}, \ref{eq:total}, and
...
doesn't add any additional information (it is already part of
...
simulation period was from the year 2000 to 2600.
...
Denmark.  The particle size distribution of the two soils are listed
in Table~\ref{tab:psd}.
\begin{table}[htbp]
