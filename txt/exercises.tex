...
The command \verb|(log_prefix "E1/")| will place all output files in
a subfolder (\texttt{E1}) of the current folder.  You must create the
subfolder before starting the simulation.
